...
public class NestScore : Singleton<NestScore>
{
    ...
    public int GetRank()
    {
        if (score > totalNote * 1.1 * 20)
        {
            return 5;
        }
        else if (score > totalNote * 0.8 * 20)
        {
            return 4;
        }
        else if (score > totalNote * 0.6 * 20)
        {
            return 3;
        }
        else if (score > totalNote * 0.4 * 20)
        {
            return 2;
        }
        else if (score > totalNote * 0.3 * 20)
        {
            return 1;
        }
        return 0;
